...
const HELSINKI_PREMIUM: StagingProductFixture[] = [
  { id: 1,  name: 'Koskenkorva Viina',         manufacturer: 'Koskenkorva',     brand: 'Koskenkorva',      category: 'spirits',          alcoholByVolume: 0.38,   unitVolume: 0.700, containerType: 'bottle', regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '6410600010101' },
  { id: 2,  name: 'Koskenkorva Salmiakki',     manufacturer: 'Koskenkorva',     brand: 'Koskenkorva',      category: 'spirits',          alcoholByVolume: 0.32,   unitVolume: 0.500, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '6410600010118' },
  { id: 3,  name: 'Absolut Vodka',             manufacturer: 'Absolut',         brand: 'Absolut',          category: 'spirits',          alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '7312040017306' },
  { id: 4,  name: 'Absolut Original',          manufacturer: 'Absolut',         brand: 'Absolut',          category: 'spirits',          alcoholByVolume: 0.4,   unitVolume: 1.000, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '7312040017313' },
  { id: 5,  name: 'Jameson Irish Whiskey',     manufacturer: 'Jameson',         brand: 'Jameson',          category: 'spirits',          alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '5011007000218' },
  { id: 6,  name: 'Johnnie Walker Black Label', manufacturer: 'Johnnie Walker', brand: 'Johnnie Walker',   category: 'spirits',          alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '5000267015777' },
  { id: 7,  name: 'Beefeater London Dry Gin',  manufacturer: 'Beefeater',       brand: 'Beefeater',        category: 'spirits',          alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '5010327104830' },
  { id: 8,  name: 'Bacardi Carta Blanca',      manufacturer: 'Bacardi',         brand: 'Bacardi',          category: 'spirits',          alcoholByVolume: 0.375,   unitVolume: 0.700, containerType: 'bottle',  regulatoryClassification: 'spirits',      depositSystemStatus: false, ean: '5000219000172' },
  { id: 9,  name: 'Château Margaux 2019',      manufacturer: 'Château Margaux', brand: 'Château Margaux',  category: 'wine_still',       alcoholByVolume: 0.135,   unitVolume: 0.750, containerType: 'bottle',  regulatoryClassification: 'wine_still',      depositSystemStatus: false, ean: '3350930000197' },
  { id: 10, name: 'Moët & Chandon Brut',       manufacturer: 'Moët & Chandon',  brand: 'Moët & Chandon',   category: 'wine_sparkling',   alcoholByVolume: 0.12,   unitVolume: 0.750, containerType: 'bottle',  regulatoryClassification: 'wine_sparkling',      depositSystemStatus: false, ean: '3057640032593' },
];
...
const SUOMI_LOGISTIIKKA: StagingProductFixture[] = [
  { id: 11, name: 'Sandels Lager 24pk',  manufacturer: 'Sandels',   brand: 'Sandels',   category: 'beer',           alcoholByVolume: 0.047, unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'beer',      depositSystemStatus: true,  ean: '6411953111110' },
  { id: 12, name: 'Karjala 24pk',        manufacturer: 'Karjala',   brand: 'Karjala',   category: 'beer',           alcoholByVolume: 0.046, unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'beer',      depositSystemStatus: true,  ean: '6411953222220' },
  { id: 13, name: 'Lapin Kulta 24pk',    manufacturer: 'Lapin Kulta', brand: 'Lapin Kulta', category: 'beer',         alcoholByVolume: 0.045, unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'beer',      depositSystemStatus: true,  ean: '6411953333330' },
  { id: 14, name: 'Olvi 12pk',           manufacturer: 'Olvi',      brand: 'Olvi',      category: 'beer',           alcoholByVolume: 0.045, unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'beer',      depositSystemStatus: true,  ean: '6411953444440' },
  { id: 15, name: 'Koff 24pk',           manufacturer: 'Koff',      brand: 'Koff',      category: 'beer',           alcoholByVolume: 0.047, unitVolume: 0.330, containerType: 'bottle', regulatoryClassification: 'beer',      depositSystemStatus: true,  ean: '6411953555550' },
  { id: 16, name: 'Fanta Orange',        manufacturer: 'Fanta',     brand: 'Fanta',     category: 'non_alcoholic',  alcoholByVolume: null, unitVolume: 1.500, containerType: 'bottle', regulatoryClassification: 'non-alcoholic',  depositSystemStatus: true,  ean: '5449000000996' },
  { id: 17, name: 'Coca-Cola 24pk',      manufacturer: 'Coca-Cola', brand: 'Coca-Cola', category: 'non_alcoholic',  alcoholByVolume: null, unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'non-alcoholic',  depositSystemStatus: true,  ean: '5449000009999' },
  ...
  { id: 19, name: 'Kevytmaito',          manufacturer: 'Valio',     brand: 'Valio',     category: 'non_alcoholic',  alcoholByVolume: null, unitVolume: 1.000, containerType: 'carton', regulatoryClassification: 'non-alcoholic', depositSystemStatus: false, ean: '6410123456780' },
...
const POHJOLAN_TUONTI: StagingProductFixture[] = [
  { id: 21, name: 'Põhjala Must Kuld',        manufacturer: 'Põhjala',      brand: 'Põhjala',      category: 'beer', alcoholByVolume: 0.105, unitVolume: 0.330, containerType: 'bottle', regulatoryClassification: 'beer', depositSystemStatus: true, ean: '4740079123451' },
  { id: 22, name: 'Põhjala Virmalised',       manufacturer: 'Põhjala',      brand: 'Põhjala',      category: 'beer', alcoholByVolume: 0.08,  unitVolume: 0.330, containerType: 'bottle', regulatoryClassification: 'beer', depositSystemStatus: true, ean: '4740079123468' },
  { id: 23, name: 'Sori Brewing Long Dreams', manufacturer: 'Sori Brewing', brand: 'Sori Brewing', category: 'beer', alcoholByVolume: 0.065,  unitVolume: 0.440, containerType: 'can',    regulatoryClassification: 'beer', depositSystemStatus: true, ean: '4740079222222' },
  { id: 24, name: 'Sori Brewing Citra IPA',   manufacturer: 'Sori Brewing', brand: 'Sori Brewing', category: 'beer', alcoholByVolume: 0.055,  unitVolume: 0.440, containerType: 'can',    regulatoryClassification: 'beer', depositSystemStatus: true, ean: '4740079222239' },
  { id: 25, name: 'Mikkeller Green Gold',     manufacturer: 'Mikkeller',    brand: 'Mikkeller',    category: 'beer', alcoholByVolume: 0.08,  unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'beer', depositSystemStatus: true, ean: '5711833001234' },
  { id: 26, name: 'To Øl Garden of Eden',     manufacturer: 'To Øl',        brand: 'To Øl',        category: 'beer', alcoholByVolume: 0.068,  unitVolume: 0.330, containerType: 'can',    regulatoryClassification: 'beer', depositSystemStatus: true, ean: '5711833002239' },
  { id: 27, name: 'Fat Lizard Kama IPA',      manufacturer: 'Fat Lizard',   brand: 'Fat Lizard',   category: 'beer', alcoholByVolume: 0.065,  unitVolume: 0.440, containerType: 'can',    regulatoryClassification: 'beer', depositSystemStatus: true, ean: '6438456000011' },
  { id: 28, name: 'Fat Lizard Saison',        manufacturer: 'Fat Lizard',   brand: 'Fat Lizard',   category: 'beer', alcoholByVolume: 0.055,  unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'beer', depositSystemStatus: true, ean: '6438456000028' },
];

/** ArcticBev — Large beverage importer (products 29–36). Fixture bottles → glass. */
const ARCTIC_BEVERAGES: StagingProductFixture[] = [
  { id: 29, name: 'Château Haut-Brion 2018',    manufacturer: 'Château Haut-Brion', brand: 'Château Haut-Brion', category: 'wine_still',     alcoholByVolume: 0.14,   unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'wine_still', depositSystemStatus: false, ean: '3350930000198' },
  { id: 30, name: 'Penfolds Grange 2017',       manufacturer: 'Penfolds',           brand: 'Penfolds',           category: 'wine_still',     alcoholByVolume: 0.145,   unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'wine_still', depositSystemStatus: false, ean: '9310297009197' },
  { id: 31, name: 'Veuve Clicquot Brut',        manufacturer: 'Veuve Clicquot',     brand: 'Veuve Clicquot',     category: 'wine_sparkling', alcoholByVolume: 0.12,   unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'wine_sparkling', depositSystemStatus: false, ean: '3057640050634' },
  { id: 32, name: 'Grey Goose Vodka',           manufacturer: 'Grey Goose',         brand: 'Grey Goose',         category: 'spirits',        alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle', regulatoryClassification: 'spirits', depositSystemStatus: false, ean: '3100000000190' },
  { id: 33, name: 'Hennessy XO',                manufacturer: 'Hennessy',           brand: 'Hennessy',           category: 'spirits',        alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle', regulatoryClassification: 'spirits', depositSystemStatus: false, ean: '3100000000398' },
  { id: 34, name: 'Laphroaig 10 Year Old',      manufacturer: 'Laphroaig',          brand: 'Laphroaig',          category: 'spirits',        alcoholByVolume: 0.4,   unitVolume: 0.700, containerType: 'bottle', regulatoryClassification: 'spirits', depositSystemStatus: false, ean: '5000213009105' },
  { id: 35, name: 'Chablis Premier Cru',        manufacturer: 'Domaine Pattes Loup', brand: 'Domaine Pattes Loup', category: 'wine_still',   alcoholByVolume: 0.125,   unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'wine_still', depositSystemStatus: false, ean: '3760036481234' },
  { id: 36, name: 'Perrier-Jouët Belle Epoque', manufacturer: 'Perrier-Jouët',      brand: 'Perrier-Jouët',      category: 'wine_sparkling', alcoholByVolume: 0.125,   unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'wine_sparkling', depositSystemStatus: false, ean: '3057640070632' },
];
...
const STANDALONE: StagingProductFixture[] = [
  { id: 45, name: 'Sample Aperitif', manufacturer: 'Generic', brand: 'Generic', category: 'intermediate_products', alcoholByVolume: 0.18, unitVolume: 0.750, containerType: 'bottle', regulatoryClassification: 'intermediate_products', depositSystemStatus: false, ean: null },
];
