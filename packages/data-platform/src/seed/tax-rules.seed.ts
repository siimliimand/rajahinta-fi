...
const BEER_FULL_RATE: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'beer_progressive',
...
const BEER_SMALL_BREWERY_RATE: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'beer_progressive_small_brewery',
  officialSource: SOURCE_VERO_FI,
  verificationDate: VERIFIED_2024_Q1,
  versionLabel: VERSION,
};
...
const WINE_STILL_LOW: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'wine_by_abv',
  officialSource: SOURCE_VERO_FI,
  verificationDate: VERIFIED_2024_Q1,
  versionLabel: VERSION,
};
...
const SPIRITS_RATE: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'spirits_pure_alcohol',
  officialSource: SOURCE_VERO_FI,
  verificationDate: VERIFIED_2024_Q1,
  versionLabel: VERSION,
};
...
const INTERMEDIATE_LOW: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'intermediate_by_abv',
  officialSource: SOURCE_VERO_FI,
  verificationDate: VERIFIED_2024_Q1,
  versionLabel: VERSION,
};
...
const OTHER_FERMENTED_LOW: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'other_fermented_by_abv',
  officialSource: SOURCE_VERO_FI,
  verificationDate: VERIFIED_2024_Q1,
  versionLabel: VERSION,
};
...
const CONTAINER_DUTY: TaxRuleSeed = {
  ...
  calculationFormulaReference: 'container_duty_flat',
  officialSource: SOURCE_VERO_FI,
  verificationDate: VERIFIED_2024_Q1,
  versionLabel: VERSION,
};
