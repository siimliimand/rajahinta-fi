 ...
 */
import type { CalculatorResult, ClassificationResult, TransportArrangement } from '@rajahinta/core-domain';
 ...
 * decision.
 */
export type CalculationResultResponse = Omit<CalculatorResult, 'classification'> & {
