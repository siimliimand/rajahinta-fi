...
// ---------------------------------------------------------------------------
// Embedded methodology data (lockstep with RankingService)
// ---------------------------------------------------------------------------

/**
 * Sort order descriptions kept in lockstep with `RankingService.describeSortOrder()`.
 *
 * These must match the descriptions in
 * `packages/core-domain/src/ranking/ranking.service.ts` exactly.
 * Update both files when adding or changing sort orders.
 */
const SORT_ORDER_DESCRIPTIONS: Record<SortOrder, string> = {
  LOWEST_LANDED_COST:
