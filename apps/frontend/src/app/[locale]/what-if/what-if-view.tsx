...
/**
 * What-if simulator view (price-intelligence-roadmap task 2.4, the D2
 * server-shell conversion): the interactive scenario flow moved intact
 * from the former single-file page. The server shell in `page.tsx` owns
 * the metadata, intro copy with the example scenario questions, and the
 * method summary; this view renders everything that needs the visitor's
 * interaction state.
 *
 * Behaviour (task 8.3, change product-roadmap-phases-1-4):
