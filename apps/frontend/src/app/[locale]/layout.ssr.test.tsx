 ...
 *      destinations, the disclaimer, and the methodology link from
...
// ---------------------------------------------------------------------------
// Mocked Next server plumbing — locale is steerable per test through this
// hoisted object.
// ---------------------------------------------------------------------------
...
describe('SiteHeader SSR — every destination, both locales', () => {
  ...
  it.each(['fi', 'en'] as const)('renders the localized destinations (%s)', async (locale) => {
    state.pathname = '/';
...
// ---------------------------------------------------------------------------
// 2. Real layout composition — chrome slots, lang, age gate
// ---------------------------------------------------------------------------
