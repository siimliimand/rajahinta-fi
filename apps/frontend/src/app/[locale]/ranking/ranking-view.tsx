...
/**
 * Ranking methodology view (price-intelligence-roadmap task 2.4, the D2
 * server-shell conversion): the methodology content moved intact from the
 * former single-file page. The server shell in `page.tsx` owns the
 * metadata, intro copy, and the method summary; this view renders the
 * API-supplied methodology data and its fallbacks.
 *
