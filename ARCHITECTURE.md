...
│           ├── ops/                   # Operator console API (flag-gated OPERATOR_CONSOLE): governance grants, dataset confirmations, correction queue; fully audited
...
| **Operator console** | Flag-gated (`OPERATOR_CONSOLE`, default off): governance grants, dataset confirmations, correction queue | `apps/frontend/src/app/[locale]/ops/`, `packages/application-api/src/ops/` |
