...
| -------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Layout**           | Shared header (calculator, compare, basket, account, ranking) and footer (disclaimer, methodology); per-page back-links removed | `apps/frontend/src/app/[locale]/layout.tsx`                        |
| **Home page**        | Navigation hub linking to calculator, compare, ranking, account                             | `apps/frontend/src/app/[locale]/page.tsx`                          |
