...
| `packages/data-acquisition` | Merchant feed ingestion pipeline (Alko domestic reference, alks.fi and longero.fi Store APIs), carrier sources (Posti), data-quality checks, rate-review scheduler | `adapters/`, `services/`, `__fixtures__/` |
