...
- [ ] 3.1 Register adapters in the `apps/backend` composition root — merchant-terms port adapter over the repository, optimizer module wiring <!-- agent: platform-engineer.build, depends_on: [2.1, 1.1, 1.2], touches: [apps/backend/src/**] -->
