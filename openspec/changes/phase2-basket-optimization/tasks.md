...
- [x] 6.2 Update `docs/tasks.md` — mark T2.6 through T2.9 with completion notes referencing this change <!-- agent: platform-engineer.fast, depends_on: [6.1], touches: [docs/tasks.md] -->
