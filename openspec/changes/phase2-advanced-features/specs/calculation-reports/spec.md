...
Exportable calculation reports: a user can take a completed landed-cost calculation away as a structured JSON document, a flat CSV table, or a printable HTML report, with full provenance and the structural disclaimer in every format. Implements T2.11 of the implementation plan.
